<template>
  <div
    ...
    :aria-activedescendant="
      isOpen && pointer !== null ? id + '-' + pointer : null
    "
  >
...
export default {
  ...
  props: {
     ...
     * @default 'Premi invio per selezionare'
     * @type {String}
     */
    selectLabel: {
      type: String,
    ...
    selectGroupLabel: {
      type: String,
      default: "Premi invio per selezionare il gruppo",
    },
    /**
     ...
     * @default 'Premi invio per rimuovere'
     * @type {String}
     */
    deselectLabel: {
      type: String,
    ...
    deselectGroupLabel: {
      type: String,
      default: "Premi invio per deselezionare il gruppo",
    },
    /**
